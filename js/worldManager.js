...
import { createAnimalGraveyard } from './graveyardManager.js';
...
export function setGateBarrier(barrier) { gateBarrier = barrier; }
...
export function addCollidableWall(wall) {
...
// Graveyard functions moved to graveyardManager.js
// createAnimalGraveyard is imported from graveyardManager.js
...
function createORNT1Portal(scene) {
    ...
    ornT1Portal.userData = {
        ...
        useXZDistance: true,           // Ignore Y when calculating proximity
        interactionRadiusSq: 6.0 * 6.0 // Larger radius so it's easier to interact on bridge
    };
